...
<div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="apellido2" type="text" class="form-control @error('Apellido') is-invalid @enderror" name="apellido_materno" value="{{ old('apellido_materno') }}" required  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fecha" type="text" class="form-control @error('Fecha Nacimiento') is-invalid @enderror" name="fecha_nac" value="{{ old('fecha_nac') }}" required  autofocus>
